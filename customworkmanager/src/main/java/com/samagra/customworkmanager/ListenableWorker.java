...
public abstract class ListenableWorker {
    ...
    /**
     * Gets the list of content {@link Uri}s that caused this Worker to execute.  See
     * {@code JobParameters#getTriggeredContentUris()} for relevant {@code JobScheduler} code.
     *
     * @return The list of content {@link Uri}s that caused this Worker to execute
    ...
    /**
     * Gets the {@link Network} to use for this Worker.  This method returns
    ...
    public abstract static class Result {
         ...
         * to run, you need to return {@link Success}</b>; failure indicates a permanent
