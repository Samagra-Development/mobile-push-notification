 ...
 * after its {@link com.samagra.customworkmanager.Constraints} are met.  WorkManager allows observation of work
 ...
 * <p>
 * All work must be done in a {@link com.samagra.customworkmanager.ListenableWorker} class.  A simple
 * implementation, {@link com.samagra.customworkmanager.Worker}, is recommended as the starting point for most
 ...
 * <p>
 * There are two types of work supported by WorkManager: {@link com.samagra.customworkmanager.OneTimeWorkRequest}
 * and {@link com.samagra.customworkmanager.PeriodicWorkRequest}.  OneTimeWorkRequests can be chained together into
 ...
 * <p>
 * WorkRequests can accept {@link com.samagra.customworkmanager.Constraints}, inputs (see
 * {@link com.samagra.customworkmanager.Data}), and backoff criteria.  WorkRequests can be tagged with
 * human-readable Strings (see {@link com.samagra.customworkmanager.WorkRequest.Builder#addTag(String)}), and
 ...
 * {@link com.samagra.customworkmanager.Configuration}.  ContentProviders are created and run before the
 ...
 * custom {@link com.samagra.customworkmanager.Configuration} by using {@link com.samagra.customworkmanager.Configuration.Provider}
 * or
 * {@link com.samagra.customworkmanager.WorkManager#initialize(android.content.Context, com.samagra.customworkmanager.Configuration)}.
 * <p>
 * <b>WorkManager and its Interactions with the OS</b>
 * <p>
 * WorkManager {@code BroadcastReceiver}s to monitor {@link com.samagra.customworkmanager.Constraints} on devices
 ...
 *     23 and monitor network {@link com.samagra.customworkmanager.Constraints}</li>
